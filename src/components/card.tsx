...
export function Card({ title, date, description, ...rest }: CardProps) {
  return (
    <a
      className="p-8 h-64 flex flex-col gap-5 bg-base-post border-2 border-base-post rounded-[10px] hover:transition-all hover:duration-300 hover:border-base-label cursor-pointer"
      {...rest}
    >
